                ...
                <div className="container">
                    <div className="site-footer-inner">
                        <div className="brand footer-brand">
                            <a href>
                                <img className="header-logo-image" src="https://cdn.xoniaapp.com/static/logo.png" alt="Logo" width="90px" height="97px" />
                            </a>
                        </div>
                        <ul className="footer-links list-reset">
                            ...
                            <li>
                                <a href="https://support.xoniaapp.com/">Support</a>
                            </li>
                        </ul>
                        <ul className="footer-social-links list-reset">
                            <li>
                                <a href="https://discord.gg/PuvsTkhmXG">
                            ...
                            <li>
                                <a href="https://github.com/xoniaplay">
                        ...
                        <div className="footer-copyright">
                            ©2021 Xonia, all rights reserved. Xonia is a
                            Trademark of Xonia, Inc.
                        </div>
                    </div>
                </div>
            </footer>
